  ...
  return (
    <main className="flex-1 flex flex-col relative overflow-y-auto pb-8 bg-bg-app">
        ...
        <div className="bg-primary rounded-3xl p-6 text-white shadow-lg relative overflow-hidden">
          <div className="relative z-10">
            <h3 className="text-2xl font-bold mb-2 pr-10">
              Punya Sisa Bahan di Kulkas?
            </h3>
            <p className="text-white/80 text-sm mb-6 max-w-[90%] leading-relaxed">
              Foto bahan makananmu sekarang, biar AI racikkan resep lezatnya
      ...
      <div className="mx-6 mb-8 bg-white p-6 rounded-2xl border border-border shadow-sm flex gap-4 items-start">
        ...
        <div>
          <h3 className="font-bold text-text-main text-sm mb-2">
            Tentang KulKul
          </h3>
          <p className="text-text-muted text-xs leading-relaxed">
            KulKul adalah asisten dapur pintar yang membantu kamu mendeteksi
            bahan makanan dari foto kulkas, mengurangi food waste, dan
            menyajikan panduan langkah memasak interaktif yang bebas ribet.
          </p>
        </div>
      </div>
      ...
      <div className="mb-8 bg-white p-6 mx-6 rounded-2xl border border-border shadow-sm">
        ...
        <div className="flex gap-4 mb-2">
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 rounded-full bg-primary/10 text-primary border border-primary/20 flex items-center justify-center font-bold text-sm shrink-0 z-10">
              1
            </div>
